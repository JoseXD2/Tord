function onCreate()
    makeLuaSprite('Sky', 'trolled/stageback', -600, -200)
    setLuaSpriteScrollFactor('Sky', 0.9, 0.9);
    makeLuaSprite('StageFront', 'trolled/stagefront', -650, 600)
    setGraphicSize('StageFront', 2560, 639);
    setLuaSpriteScrollFactor('StageFront', 0.9, 0.9);
    makeLuaSprite('StageCurtains', 'trolled/stagecurtains', -450, -350)
